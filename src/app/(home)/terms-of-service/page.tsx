  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <Link href="#intellectual-property-rights"></Link>INTELLECTUAL
          PROPERTY RIGHTS
        </li>
        <li>
          <Link href="#user-representations">USER REPRESENTATIONS</Link>
        </li>
        <li>
          <Link href="#user-registration">USER REGISTRATION</Link>
        </li>
        <li>
          <Link href="#purchases-and-payment"></Link>PURCHASES AND PAYMENT
        </li>
        <li>
          <Link href="#subscriptions">SUBSCRIPTIONS</Link>
        </li>
        <li>
          <Link href="#prohibited-activities">PROHIBITED ACTIVITIES</Link>
        </li>
        <li>
        ...
        <li>
          <Link href="#contribution-license">CONTRIBUTION LICENSE</Link>
        </li>
        <li>
          <Link href="#guidelines-for-reviews">GUIDELINES FOR REVIEWS</Link>
        </li>
        <li>
          <Link href="#social-media">SOCIAL MEDIA</Link>
        </li>
        <li>
          <Link href="#third-party-websites-and-content">
            THIRD-PARTY WEBSITES AND CONTENT
          </Link>
        </li>
        <li>
          <Link href="#services-management">SERVICES MANAGEMENT</Link>
        </li>
        <li>
          <Link href="#privacy-policy">PRIVACY POLICY</Link>
        </li>
        <li>
          <Link href="#copyright-infringements">COPYRIGHT INFRINGEMENTS</Link>
        </li>
        <li>
          <Link href="#term=and-termination">TERM AND TERMINATION</Link>
        </li>
        <li>
        ...
        <li>
          <Link href="#govering-law">GOVERNING LAW</Link>
        </li>
        <li>
          <Link href="#dispute-resolution">DISPUTE RESOLUTION</Link>
        </li>
        <li>
          <Link href="#correctiond">CORRECTIONS</Link>
        </li>
        <li>
          <Link href="#disclaimer">DISCLAIMER</Link>
        </li>
        <li>
          <Link href="#limitations-of-liability">LIMITATIONS OF LIABILITY</Link>
        </li>
        <li>
        ...
        <li>
          <Link href="#electronic-communications-transactions-and-signatures">
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </Link>
        </li>
        <li>
          <Link href="#california-users-and-residents">
      ...
      <p>
        ...
        address your request to: tasklytic@inbox.ru. If we ever grant you the
      ...
      <h2>Your submissions and contributions</h2>
      <p>
      ...
      <p>
        ...
        <Link href="#copyright-infringements">
      ...
      <p>
        ...
        change prices at any time. All payments shall be in Rubles.
      </p>
      <p>
      ...
      <h3>Cancellation</h3>
      <p>You can cancel your subscription at any time in your settings.</p>
      <p>
        ...
        email us at tasklytic@inbox.ru.
      </p>
      <h3>Fee Changes</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          use the Services and/or the Content for any revenuegenerating endeavor
      ...
      <p>
        ...
        your Contributions. We are not liable for any statements or
        representations in your Contributions provided by you in any area on the
        Services. You are solely responsible for your Contributions to the
      ...
      <p>
        ...
        Services; and (3) to prescreen or delete any Contributions at any time
      ...
      <h2 id="social-media">11. SOCIAL MEDIA</h2>
      <p>
        ...
        obtained through such ThirdParty Account, except the username and
      ...
      <p>
        ...
        Websites accessed through the Services or any ThirdParty Content posted
        ...
        use or install any ThirdParty Content, you do so at your own risk, and
        ...
        Services. Any purchases you make through ThirdParty Websites will be
      ...
      <p>
        ...
        Policy:{" "}
        <Link href="https://task-lytic.vercel.app/privacy-policy">
          https://task-lytic.vercel.app/privacy-policy
        </Link>
        ...
        Services are hosted in Russia and United States. If you access the
        ...
        differ from applicable laws in Russia and United States, then through
        your continued use of the Services, you are transferring your data to
        Russia and United States, and you expressly consent to have your data
        transferred to and processed in Russia and United States.
      </p>
      <h2 id="copyright-infringements">15. COPYRIGHT INFRINGEMENTS</h2>
      <p>
        We respect the intellectual property rights of others. If you believe
        that any material available on or through the Services infringes upon
      ...
      <h2 id="term=and-termination">16. TERM AND TERMINATION</h2>
      <p>
      ...
      <h2 id="correctiond">20. CORRECTIONS</h2>
      <p>
      ...
      <h2 id="limitations-of-liability">22. LIMITATIONS OF LIABILITY</h2>
      <p>
      ...
      <h2 id="indemnification">23. INDEMNIFICATION</h2>
      <p>
      ...
      <h2 id="user-data">24. USER DATA</h2>
      <p>
      ...
      <h2 id="contact-us">28. CONTACT US</h2>
      <p>
