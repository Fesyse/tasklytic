...
export function FloatingPanelContent({
  ...
  const panelPositionStyles = {
    left:
      side === "left" && triggerRect
        ? // 15 is measurement error
          triggerRect.right + triggerRect?.width - width + width / 2
        : triggerRect?.right && triggerRect?.width
          ? triggerRect.right - triggerRect.width
          : 0, // Adjust for the width of the panel
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            style={{
              borderRadius: 12,
              ...panelPositionStyles, // Apply position based on side
