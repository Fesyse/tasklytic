...
export const Md = {
  ...
  br: ({ className, ...props }: React.HTMLAttributes<HTMLBRElement>) => (
    <br className={cn("my-4", className)} {...props} />
  ),
  code: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code
      className={cn("rounded-md bg-slate-100 px-2 py-1", className)}
      {...props}
    />
  ),
  pre: ({ className, ...props }: React.HTMLAttributes<HTMLPreElement>) => (
    <pre
      className={cn("my-6 overflow-x-auto rounded-lg", className)}
      {...props}
    />
  )
